        ...
        <div class="container">
            ...
            <table class="table table-bordered">
                ...
                <%
                    ...
                    List<Materia>list=carridao.listar();
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text-center">
                            <a class="btn btn-primary" onclick="alerta()" href="Controlador?accion=AgregarCarrito&id=<%= carri.getId_producto()%>">Agregrar al carrito</a>
                            <a class="btn btn-danger" href="Controlador?accion=eliminarMaterias&id=<%= carri.getId_producto()%>">Eliminar</a>
                        </td>
                    </tr>
                    <%}%>
                </tbody>
